	...
	UClass* Z_Construct_UClass_ATutoJoueur()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_Craft = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Craft"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(Craft, ATutoJoueur), 0x0010000000000005);
				UProperty* NewProp_Craft_Inner = new(EC_InternalUseOnlyConstructor, NewProp_Craft, TEXT("Craft"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FCraft());
				UProperty* NewProp_IndexCraft = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("IndexCraft"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(IndexCraft, ATutoJoueur), 0x0010000000000005);
				...
				MetaData->SetValue(NewProp_Craft, TEXT("Category"), TEXT("Craft"));
				MetaData->SetValue(NewProp_Craft, TEXT("ModuleRelativePath"), TEXT("TutoJoueur.h"));
				MetaData->SetValue(NewProp_IndexCraft, TEXT("Category"), TEXT("Craft"));
				MetaData->SetValue(NewProp_IndexCraft, TEXT("ModuleRelativePath"), TEXT("TutoJoueur.h"));
#endif
			}
		}
